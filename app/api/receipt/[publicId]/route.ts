...
const FOOTER_TEXT =
  "Document generated by RW Capital Holding. This is not an official SWIFT message.";
...
export async function GET(
  ...
  row("Beneficiary", tx.recipientName ?? "—");
